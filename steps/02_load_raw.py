...
def load_all_raw_tables(session):
    _ = session.sql("ALTER WAREHOUSE DEVELOPER_WH SET WAREHOUSE_SIZE = XLARGE WAIT_FOR_COMPLETION = TRUE").collect()
    ...
    _ = session.sql("ALTER WAREHOUSE DEVELOPER_WH SET WAREHOUSE_SIZE = XSMALL").collect()
